<? php
	...
	sudo apt-get install php8.2 wget
	
	// php 확장자 설치
	sudo apt-get install php8.2-curl php8.2-dom -y
	...
	sudo git clone https://github.com/Junjehyun/all-star_laravel.git folderName
