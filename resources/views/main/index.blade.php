...
<div class="grid grid-cols-2 gap-10 px-24 mt-24">
    <div class="bg-white shadow-lg rounded-lg p-6 w-full h-auto flex flex-col justify-between">
        ...
        <div class="flex flex-row items-center justify-center space-x-4 mt-5">
            <a href="#" class="text-center text-sm text-blue-500 hover:underline">상의</a>
            <a href="#" class="text-center text-sm text-blue-500 hover:underline">하의</a>
            <a href="#" class="text-center text-sm text-blue-500 hover:underline">아우터</a>
            <a href="#" class="text-center text-sm text-blue-500 hover:underline">신발</a>
            <a href="#" class="text-center text-sm text-blue-500 hover:underline">ETC</a>
            <a href="#" class="text-center text-sm text-red-500 font-semibold hover:underline">SALE</a>
        </div>
        <a href="/item_index">
            <h2 class="text-right text-xs mt-10">쇼핑몰로 이동</h2>
        </a>
    </div>
        <div class="bg-white shadow-lg rounded-lg p-6 w-full h-64 flex flex-col justify-between">
            ...
            @endforeach
            <a href="notice_index">
                <h2 class="text-right text-xs mt-10">전체보기</h2>
            </a>
        </div>
    <div class="bg-white shadow-lg rounded-lg p-6 w-full h-64 flex flex-col justify-between">
