    ...
    <table class="w-3/5 table-auto border-collapse border border-gray-100 text-left">
        <thead>
            <tr class="bg-zinc-50">
                ...
                <th class="border border-gray-300 text-sm px-4 py-2 w-4/12">タイトル</th>
                <th class="border border-gray-300 text-sm px-4 py-2 w-1/12">作成者</th>
                <th class="border border-gray-300 text-sm px-4 py-2 w-1/12">作成日</th>
                <th class="border border-gray-300 text-sm px-4 py-2 w-1/12">照会</th>
                <th class="border border-gray-300 text-sm px-4 py-2 w-1/12">管理</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="border border-gray-300 px-4 py-2 text-sm">{{ $notice->like }}</td>
                ...
                <td class="border border-gray-300 px-4 py-2 text-sm text-center">{{ $notice->view }}</td>
