        ...
        <form action="{{ route('item.update', $item->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex justify-between space-x-3">
                ...
                <div class="w-1/2">
                    ...
                    <input type="text" name="size" id="size" value="{{ old('size', $item->size) }}mm" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="S, M, L, XL, XXL">
                </div>
            </div>
            <div>
